...
def draw_bg():
    ...
    for x in range(5):
        ...
        screen.blit(sand_img, ((x * width) - bg_scroll * 0.6, HEIGHT - sand_img.get_height()))
        screen.blit(pine1_img, ((x * width) - bg_scroll * 0.7, HEIGHT - pine1_img.get_height()))
        screen.blit(palm_img, ((x * width) - bg_scroll * 0.8, HEIGHT - palm_img.get_height()))

"""Clase player, donde se le da forma al protagonita y al evemigo"""
...
#Se añade los sprites a los grupos
...
"""Se crea una lista que representa el diseño del invel. La lista tiene filas y columnas."""
world_data = []
